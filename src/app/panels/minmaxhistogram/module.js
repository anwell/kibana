...
function (angular, app, $, _, kbn, moment, timeSeries, numeral, config) {
  ...
  var module = angular.module('kibana.panels.minmaxhistogram', []);
  app.useModule(module);

  module.controller('minmaxhistogram', function($scope, querySrv, dashboard, filterSrv, $http) {
    $scope.panelMeta = {
      modals : [
        {
          description: "Inspect",
      ...
      editorTabs : [
        {
          title:'Style',
          src:'app/panels/minmaxhistogram/styleEditor.html'
        },
        {
          title:'Queries',
